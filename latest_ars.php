<div class="box">
	<h2><?php _e('Latest from the blog', 'arsofia'); ?>
		<span class="small-all">
			<a
				href="<?php echo get_option('home'); ?>items/blog"
				title="<?php _e('Read Blog', 'arsofia'); ?>">
				<?php _e('Read Blog', 'arsofia'); ?>
			</a>
		</span>
	</h2>
	<?php
		...
		<div class="post">
			<div id="post-img">
				...
				<a href="<?php the_permalink(); ?>" rel="bookmark" title="<?php the_title(); ?>">
					<img
						src="<?php bloginfo('template_directory'); ?>/thumb.php?w=140&amp;h=140&amp;zc=1&amp;src=<?php echo $photo; ?>"
						width="140"
						height="140"
						alt="<?php the_title(); ?>"/>
				</a>
	...
	<h2><span class="small-all"><a href="<?php echo get_option('home'); ?>items/blog"
								   title="<?php _e('Read Blog', 'arsofia'); ?>"><?php _e('Read Blog', 'arsofia'); ?></a></span>
	</h2>
	<div class="fix"></div>
