...
(function($) {
    $(function() {
        $(document).on('facetwp-loaded', function() {
            ...
            document.cookie = "faceturl="+url+"; expires="+date.toGMTString()+"; path=/";
        });
    });
})(jQuery);
</script>
		...
		<div id="archivebox">
			...
			<?php while (have_posts()) : the_post(); ?>		
                ...
                <?php echo do_shortcode( '[facetwp sort="true"]' ); ?>
                	...
                	<div id="search-tools">
                     <div class="fix"></div>
                     <?php if(current_user_can('manage_options') or $current_user->ID == 12) {?>
                    <div class="an-box">
                    ...
                    <div class="an-box anbox-age">
                    <h3><?php _e('Age:', 'arsofia'); ?></h3>
                    <?php echo do_shortcode( '[facetwp sort="true"]' ); ?>
                	</div>
                </div>
                    <div class="box">
                    <h2 style="color:red;"><?php //_e('Searching is currently unavailable', 'arsofia'); ?><span class="floatright"><?php //echo do_shortcode( '[facetwp facet="search"]' ); ?></span></h2>
