...
if(! defined('FILE_CACHE_DIRECTORY') ) 		define ('FILE_CACHE_DIRECTORY', '/www/arsofia.com/files/root/uploads/cache');				// Directory where images are cached. Left blank it will use the system temporary directory (which is better for security)
